...
const generateOtp = require('./utils/generateVerificationLink'); // Import your OTP generator
const sendEmail = require('./utils/smtpFunction'); // Import your email sending function
